...
function VersionClient(jiraClient) {
    ...
    this.getAllVersions = function(opts, callback) {
        var options = {
            ...
            // console.log(this.jiraClient.buildAgileURL(`/board/${opts.boardId}/version`))
            // var options = this.buildRequestOptions(opts, 'this.jiraClient.buildAgileURL(`/board/${opts.boardId}/version`)', 'GET');
        return this.jiraClient.makeRequest(options, callback);
